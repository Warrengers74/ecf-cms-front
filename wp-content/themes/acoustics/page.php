...
$acoustics_breadcrumb_control = get_theme_mod( 'acoustics_breadcrumb_layout', false );
?>
...
<header class="section-page-header">
	<div class="container">
		<div class="row">
			<div class="<?php if( $acoustics_breadcrumb_control ){ echo "col-md-12"; } else{ echo "col-md-6"; } ?> text-left">
				<?php the_title( '<h1 class="entry-title">', '</h1>' ); ?>
			</div>
			<?php if( $acoustics_breadcrumb_control ): ?>
